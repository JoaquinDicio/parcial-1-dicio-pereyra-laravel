...
<div class="container mx-auto mt-10 px-8">
    <form action="/services/{{$service->id}}" method="POST">
        ...
        <div class="mb-4">
            ...
            <textarea rows="5" id="description" name="description" required class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="Ingrese la descripción del servicio">{{$service->description}}</textarea>
